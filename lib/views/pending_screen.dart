...
// }
//
// class _PendingOrdersScreenState extends State<PendingOrdersScreen> with WidgetsBindingObserver {
...
//     });
//     try {
//       EasyLoading.show(status: 'Fetching pending orders...');
...
//       setState(() {
//         _isLoading = false;
//         _errorMessage = controller.errorMessage ?? 'Failed to fetch pending orders';
//       });
...
//     } catch (e) {
//       Fluttertoast.showToast(
//         msg: controller.errorMessage ?? 'Failed to accept order',
//         toastLength: Toast.LENGTH_SHORT,
//         gravity: ToastGravity.BOTTOM,
//         backgroundColor: Colors.red,
//         textColor: Colors.white,
...
//                     SizedBox(height: padding * 1.5),
//                     Text("No pending orders found", style: TextStyle(fontSize: fontSize * 1.2, fontWeight: FontWeight.w500, color: Colors.grey[600])),
//                   ],
//                 ),
//               )
//                   : RefreshIndicator(
...
//                         child: Icon(Icons.check_circle, color: Colors.white, size: iconSize * 1.5),
//                       ),
//                       confirmDismiss: (direction) async => true,
//                       onDismissed: (direction) async => await _acceptOrder(job.id),
//                       child: JobCardWidget(job: job, onAccept: () async => await _acceptOrder(job.id)),
//                     );
//                   },
//                 ),
//               ),
